...
<body class="">
    ...
    <nav class="navbar navbar-top navbar-expand-md navbar-dark" id="navbar-main">
      <div class="container-fluid">
        <!-- Brand -->
        <a class="h4 mb-0 text-white text-uppercase d-none d-lg-inline-block"><i class="fas fa-spa"></i> Planta 3</a>
      ...
      <div class="container-fluid d-flex align-items-center">
        <div class="row">
          <div class="col-lg-12 col-md-10">
            <h1 class="display-2 text-white">Planta 3</h1>
          ...
          <div class="card card-profile shadow">
            <div class="row justify-content-center">
              <div class="col-lg-3 order-lg-2">
                <div class="card-profile-image">
                  <a href="#">
                    <img src="<?= base_url() ?>assets/img/plants/plant_3.jpeg" class="rounded-circle2">
                  </a>
                </div>
              </div>
            </div>
            ...
            <div class="card-body pt-0 pt-md-4">
              <div class="row">
                <div class="col">
                  <div class="card-profile-stats d-flex justify-content-center mt-md-5">
                    <div>
                      <span id="agua-head" class="heading">43%</span>
              ...
              <div class="text-center">
                ...
                <hr class="my-4" />
                <button id="plus-chart" class="btn bg-gradient-danger text-white">Reiniciar</button>
              </div>
            </div>
          </div>
        </div>
